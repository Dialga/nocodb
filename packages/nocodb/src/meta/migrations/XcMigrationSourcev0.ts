...
import * as nc_202604200000_base_trash from './v0/nc_202604200000_base_trash';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_202604200000_base_trash':
        return nc_202604200000_base_trash;
    }
  }
}
